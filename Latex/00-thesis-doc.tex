...
\begin{figure}[htpb]
  ...
  \label{ExitbyAge}
  \centering
  \includegraphics[width=0.8\textwidth]{RawHazard.pdf}
\end{figure}
...
\begin{figure}[htpb]
  ...
  \label{StaybyAge}
  \centering
  \includegraphics[width=0.8\textwidth]{RawSurv.pdf}
\end{figure}
...
\begin{figure}[htpb]
  ...
  \label{ExitbyWave}
  \centering
  \includegraphics[width=0.8\textwidth]{WaveRate.pdf}
\end{figure}
...
Figure \ref{modSurv} shows the survival functions for the base model including the impact on the survival model of a 10\% increase (triangles) and reduction (crosses) in hazard rates. Table \ref{ageFactor} shows the average age of leaving home from the base model as well as the average ages for proportional increases and reductions in hazard rates.
 ...
 \begin{figure}[htpb]
   ...
   \label{modSurv}
   \centering
   \includegraphics[width=0.8\textwidth]{ModSurv.pdf}
 \end{figure}
...
\begin{figure}[htpb]
  ...
  \label{plotSurv}
  \centering
  \includegraphics[width=0.8\textwidth]{plotSurv.pdf}
\end{figure}
